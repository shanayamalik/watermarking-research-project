...
Digital watermarking has historically evolved from simple spatial modifications to sophisticated frequency-domain embeddings.
\begin{itemize}
    \item \textbf{Least Significant Bit (LSB):} This spatial domain technique embeds information by modifying the lowest bit planes of pixel values. While it offers high capacity and imperceptibility, our experiments confirm its extreme fragility; it survives lossless operations but fails under virtually any form of compression or geometric transformation.
